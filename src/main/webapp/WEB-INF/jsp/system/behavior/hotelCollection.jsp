						...
						<table id="table_report"
							...
							<thead>
								<tr>
									...
									<th class="center">用户手机号码</th>
									<th class="center">酒店名称</th>
									<th class="center">酒店所属区域</th>
									<th class="center">酒店价格范围</th>
									<th class="center">酒店桌数</th>
								</tr>
							</thead>
											...
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													<td class='center' style="width: 30px;"><label><input
															type='checkbox' name='ids' value="${var.BEHAVIOR_ID}" /><span
													...
													<td>${var.NAME}</td>
													<td>${var.AREA}</td>
													<td>${var.STANDARDMEALFROM}- ${var.STANDARDMEALTO}</td>
