			...
			<table>
				<c:if test="${pd.ROLE_ID != '1'}">
					<tr class="info">
						...
						<td><input class="span10 date-picker" name="START_TIME"
							...
							placeholder="开通日期" title="开通日期" /></td>
					</tr>
				</c:if>
				<c:if test="${pd.ROLE_ID == '1'}">
				...
				<tr>
					...
					<td><input type="tel" name="PHONE" id="PHONE"
						value="${pd.PHONE }" placeholder="这里输入手机号" title="手机号" /></td>
				</tr>
				<tr>
					<td><input type="password" name="chkpwd" id="chkpwd"
						placeholder="确认密码" title="确认密码" /></td>
					<td><input type="text" name="SFID" id="SFID"
						value="${pd.SFID }" placeholder="这里输入身份证号" title="身份证号" /></td>
				</tr>
				<tr>
					<td><input type="text" name="NAME" id="name"
						value="${pd.NAME }" placeholder="这里输入姓名" title="姓名" /></td>
					<td><input type="number" name="YEARS" id="YEARS"
						class="input_txt" value="${pd.YEARS }" placeholder="开通年限(请输入数字)"
						title="开通年限" /></td>
				</tr>
				<tr>
